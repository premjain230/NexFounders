...
onAuthStateChanged(auth, async (user) => {
  ...
  if (userSnap.exists()) {
    ...
    if (navAvatar) setAvatar(navAvatar, currentUserData);
    if (navName) navName.textContent = currentUserData.displayName || "You";
  ...
  el.innerHTML = `
    <div class="post-header">
      <div class="post-avatar">
        ${post.photoURL
          ? `<img src="${post.photoURL}" class="post-avatar-img">`
          : (post.initials || "?")}
      </div>

      <div>
        <div class="post-name">
          <a href="profile.html?uid=${post.uid}" class="profile-link">
            ${post.displayName}
          </a>
        </div>
  ...
  matches.forEach((u) => {
    ...
    el.innerHTML = `
      <div class="search-avatar">
        ${u.photoURL
          ? `<img src="${u.photoURL}" class="post-avatar-img">`
          : (u.initials || "?")}
      </div>
      <div>
